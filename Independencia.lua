...
mount_vfs_texture_path  (current_mod_path.."/Textures/Independencia.zip")
...
GT.Name = "Independencia"
GT.DisplayName = _("Independencia Frigate")
GT.Rate = 5500
